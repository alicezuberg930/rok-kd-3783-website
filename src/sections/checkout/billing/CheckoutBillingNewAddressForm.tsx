...
// @types
import { AddressType, ICheckoutBillingAddress } from '@/@types/product';
// assets
import FormProvider, {
  RHFCheckbox,
  RHFSelect,
        ...
        <DialogContent dividers>
          <Stack spacing={3}>
            <RHFRadioGroup
              ...
              name="addressType"
              options={[
                { label: 'Home', value: AddressType[AddressType.home] },
                { label: 'Office', value: AddressType[AddressType.work] },
              ]}
            />
