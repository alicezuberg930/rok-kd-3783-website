    ...
    return (
        <Container maxWidth='lg'>
            ...
            {isNotFound ? (
                ...
                <Box sx={{ my: 2, height: '85vh', borderRadius: 2, overflow: 'hidden', border: '1px solid rgba(145,158,171,0.24)' }}>
                    <AutoSizer>
                        {
                            ({ height, width }) => (
                                <VariableSizeList
...
// Filter function
const applyFilter = ({ inputData = [], filterName }: { inputData: Question[], filterName: string }) => {
    if (filterName) {
