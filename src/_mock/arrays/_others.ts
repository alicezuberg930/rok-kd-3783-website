import { AddressType } from '@/@types/product';
...
export const _addressBooks = [...Array(5)].map((_, index) => ({
  ...
  addressType: index === 0 ? AddressType[AddressType.home] : AddressType[AddressType.work],
  isDefault: index === 0,
  email: _mock.email(index),
  companyName: randomInArray(['MicroSoft', 'Netflix', 'Amazon', 'Shopee']),
}));
...
export const _notifications = [...Array(5)].map((_, index) => ({
  ...
  createdAt: new Date(2025, index, index),
